...
eval {
    require Encode;
    $pate = Encode::decode_utf8("pÃ¢tÃ©");
    $raks = Encode::decode_utf8("rÃ¤ksmÃ¶rgÃ¥s");
    $HAS_ENCODE = 1;
};
...
# ID3v2.3 ISO-8859-1
{
    ...
    {
        skip 'Encode is not available', 3 unless $HAS_ENCODE;
        my $a = Encode::decode_utf8('Ester KoÃ¨iÃ¨kovÃ¡ a LubomÃ­r Nohavica');
        my $b = Encode::decode_utf8('Ester KoÃ¨iÃ¨kovÃ¡ a LubomÃ­r Nohavica s klavÃ­rem');
        my $c = Encode::decode_utf8('TÃ¸em sestrÃ¡m');
...
# should not read into the next frame (TCON)
{
    ...
    {
        skip 'Encode is not available', 1 unless $HAS_ENCODE;
        my $title = Encode::decode_utf8("èŠ±ç«");
...
# ID3v2.4 UTF-8
{
    ...
    SKIP:
    {
        ...
        my $a = Encode::decode_utf8('ÐªÐ­Ð¯');
        my $b = Encode::decode_utf8('ÎˆÎ¤');
        my $c = Encode::decode_utf8('Î³Î¶');
